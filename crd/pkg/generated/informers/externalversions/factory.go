...
import (
	...
	agh "github.com/bskiba/agh-talk/crd/pkg/generated/informers/externalversions/agh"
...
func (f *sharedInformerFactory) Agh() agh.Interface {
	return agh.New(f, f.namespace, f.tweakListOptions)
}
